...
$sql_guardar1="select Codigo,Nombre from tbltipomotivo where not (Codigo='0000000003');";
...
<td colspan="2" align="left" bgcolor="#00FF00" style="height: 3px"><form name="f" action="FrmAsignacion.php" method="post" onSubmit="return validar(this)"  class="ww">
  ...
  <table width="556" border="0">
    <tr>
      <td width="550" height="20" bgcolor="#0099FF"><div align="center" class="Estilo9">Registro De Documentos</div></td>
    </tr>
  </table>
  <table width="556" border="0">
    <tr>
