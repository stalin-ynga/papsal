...
e.dialog({modal:!0,width:490,closeOnEscape:!1,position:{at:"center bottom",of:a.jqschedule.calendarid},title:a.jqschedule.locales.editCaption,close:function(){e.dialog("destroy");e.hide();e=null},buttons:d}).show();a(".ui-dialog").css({"font-size":"12px","z-index":1E5});return!1},eventAddDialog:function(b,d,c,e){var f=a(a.jqschedule.eventid);a("input,textarea,select",f).val("");d?a("#endtime, #starttime",f).hide():a("#endtime, #starttime",f).show();a("#all_day",f).attr("checked",d);setTimeout(function(){a("#description",
...
"";a.each(f,function(){g+="<li>"+a(this).text()+"</li>"});a("#cal_user").html(g)}}});b.dialog("close")}},{text:a.jqschedule.locales.bCancel,click:function(){b.dialog("close")}}]}).show();a(".ui-dialog, .ui-dialog-buttonpane").css({"font-size":"12px","z-index":1000002});return!1},printEvents:function(){if(a("#b_search_cal").hasClass("ui-state-active")){var b=a("#common_search").val(),d="simple";if(""==b){var d="complex",c=a("#search_cal");if(c){c=c.jqFilter("filterData");if(!c.rules.length)return!1;
...
stype:"complex",svalue:d,oper:"getEvent"},dataType:"json",type:"POST",success:function(b,c){a.jqschedule._filSearchTable(b,"#search_table")}});b.dialog("close")}}},{text:a.jqschedule.locales.bClose,click:function(){a("#search_cal").dialog("close")}}]});a(".ui-dialog, .ui-dialog-buttonpane").css({"font-size":"12px","z-index":1000002})},editFromSearch:function(b){var d=a("tr#"+b+" td.source").html().split("~`"),c={};a.each("id title start end description location className access allDay user_id".split(" "),
