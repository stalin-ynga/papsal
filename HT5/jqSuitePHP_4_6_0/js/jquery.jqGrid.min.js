...
"'>&#160;</td><td class='DataTD form-view-data ui-helper-reset ui-widget-content'>&#160;</td>",w="",u=["integer","number","currency"],t=0,x=0,v,z,A;for(r=1;r<=f;r++)w+=1===r?s:"<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>";a(d.p.colModel).each(function(){(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)||"right"!==this.align||(this.formatter&&-1!==a.inArray(this.formatter,u)?t=Math.max(t,
parseInt(this.width,10)):x=Math.max(x,parseInt(this.width,10)))});v=0!==t?t:0!==x?x:0;q=a(d).jqGrid("getInd",c);a(d.p.colModel).each(function(b){g=this.name;z=!1;n=(k=this.editrules&&!0===this.editrules.edithidden?!1:!0===this.hidden?!0:!1)?"style='display:none'":"";A="boolean"!==typeof this.viewable?!0:this.viewable;if("cb"!==g&&"subgrid"!==g&&"rn"!==g&&A){m=!1===q?"":g===d.p.ExpandColumn&&!0===d.p.treeGrid?a("td:eq("+b+")",d.rows[q]).text():a("td:eq("+b+")",d.rows[q]).html();z="right"===this.align&&
0!==v?!0:!1;var c=a.extend({},{rowabove:!1,rowcontent:""},this.formoptions||{}),r=parseInt(c.rowpos,10)||l+1,s=parseInt(2*(parseInt(c.colpos,10)||1),10);if(c.rowabove){var u=a("<tr><td class='contentinfo' colspan='"+2*f+"'>"+c.rowcontent+"</td></tr>");a(e).append(u);u[0].rp=r}h=a(e).find("tr[rowpos="+r+"]");0===h.length&&(h=a("<tr "+n+" rowpos='"+r+"'></tr>").addClass("FormData").attr("id","trv_"+g),a(h).append(w),a(e).append(h),h[0].rp=r);a("td:eq("+(s-2)+")",h[0]).html("<b>"+(void 0===c.label?d.p.colNames[b]:
c.label)+"</b>");a("td:eq("+(s-1)+")",h[0]).append("<span>"+m+"</span>").attr("id","v_"+g);z&&a("td:eq("+(s-1)+") span",h[0]).css({"text-align":"right",width:v+"px"});p[l]=b;l++}});0<l&&(c=a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='"+(2*f-1)+"' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='"+c+"'/></td></tr>"),c[0].rp=l+99,a(e).append(c));return p}function h(b,c){var d,e,f=0,g,k;if(k=a(c).jqGrid("getInd",b,!0))a("td",k).each(function(b){d=
c.p.colModel[b].name;e=c.p.colModel[b].editrules&&!0===c.p.colModel[b].editrules.edithidden?!1:!0===c.p.colModel[b].hidden?!0:!1;"cb"!==d&&"subgrid"!==d&&"rn"!==d&&(g=d===c.p.ExpandColumn&&!0===c.p.treeGrid?a(this).text():a(this).html(),d=a.jgrid.jqID("v_"+d),a("#"+d+" span","#"+r).html(g),e&&a("#"+d,"#"+r).parents("tr:first").hide(),f++)}),0<f&&a("#id_g","#"+r).val(b)}function g(b,c){var d=c[1].length-1;0===b?a("#pData","#"+r+"_2").addClass("ui-state-disabled"):void 0!==c[1][b-1]&&a("#"+a.jgrid.jqID(c[1][b-
1])).hasClass("ui-state-disabled")?a("#pData",r+"_2").addClass("ui-state-disabled"):a("#pData","#"+r+"_2").removeClass("ui-state-disabled");b===d?a("#nData","#"+r+"_2").addClass("ui-state-disabled"):void 0!==c[1][b+1]&&a("#"+a.jgrid.jqID(c[1][b+1])).hasClass("ui-state-disabled")?a("#nData",r+"_2").addClass("ui-state-disabled"):a("#nData","#"+r+"_2").removeClass("ui-state-disabled")}function k(){var b=a(l).jqGrid("getDataIDs"),c=a("#id_g","#"+r).val();return[a.inArray(c,b),b]}var l=this;if(l.grid&&
e){var m=l.p.id,p="ViewGrid_"+a.jgrid.jqID(m),r="ViewTbl_"+a.jgrid.jqID(m),q="ViewGrid_"+m,n="ViewTbl_"+m,s={themodal:"viewmod"+m,modalhead:"viewhd"+m,modalcontent:"viewcnt"+m,scrollelm:p},t=a.isFunction(d[l.p.id].beforeInitData)?d[l.p.id].beforeInitData:!1,v=!0,u=1,w=0;b.recreateForm||a(l).data("viewProp")&&a.extend(d[a(this)[0].p.id],a(l).data("viewProp"));var x=isNaN(d[a(this)[0].p.id].dataheight)?d[a(this)[0].p.id].dataheight:d[a(this)[0].p.id].dataheight+"px",z=isNaN(d[a(this)[0].p.id].datawidth)?
d[a(this)[0].p.id].datawidth:d[a(this)[0].p.id].datawidth+"px",q=a("<form name='FormPost' id='"+q+"' class='FormGrid' style='width:"+z+";overflow:auto;position:relative;height:"+x+";'></form>"),A=a("<table id='"+n+"' class='EditTable' cellspacing='1' cellpadding='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");t&&(v=t.call(l,a("#"+p)),void 0===v&&(v=!0));if(!1!==v){a(l.p.colModel).each(function(){var a=this.formoptions;u=Math.max(u,a?a.colpos||0:0);w=Math.max(w,a?a.rowpos||0:0)});
...
width:a(b.w).width(),height:a(b.w).height(),dataheight:a("#"+p).height(),datawidth:a("#"+p).width()});b.w.remove();b.o&&b.o.remove()}});a(".fm-button:not(.ui-state-disabled)","#"+r+"_2").hover(function(){a(this).addClass("ui-state-hover")},function(){a(this).removeClass("ui-state-hover")});f();a("#cData","#"+r+"_2").click(function(){a.jgrid.hideModal("#"+a.jgrid.jqID(s.themodal),{gb:"#gbox_"+a.jgrid.jqID(m),jqm:b.jqModal,onClose:b.onClose});return!1});a("#nData","#"+r+"_2").click(function(){a("#FormError",
"#"+r).hide();var c=k();c[0]=parseInt(c[0],10);-1!==c[0]&&c[1][c[0]+1]&&(a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(l,"next",a("#"+p),c[1][c[0]]),h(c[1][c[0]+1],l),a(l).jqGrid("setSelection",c[1][c[0]+1]),a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(l,"next",a("#"+p),c[1][c[0]+1]),g(c[0]+1,c));f();return!1});a("#pData","#"+r+"_2").click(function(){a("#FormError","#"+r).hide();var c=k();-1!==c[0]&&c[1][c[0]-1]&&(a.isFunction(b.onclickPgButtons)&&b.onclickPgButtons.call(l,
"prev",a("#"+p),c[1][c[0]]),h(c[1][c[0]-1],l),a(l).jqGrid("setSelection",c[1][c[0]-1]),a.isFunction(b.afterclickPgButtons)&&b.afterclickPgButtons.call(l,"prev",a("#"+p),c[1][c[0]-1]),g(c[0]-1,c));f();return!1});q=k();g(q[0],q)}}})},delGridRow:function(e,b){b=a.extend(!0,{top:0,left:0,width:240,height:"auto",dataheight:"auto",modal:!1,overlay:30,drag:!0,resize:!0,url:"",mtype:"POST",reloadAfterSubmit:!0,beforeShowForm:null,beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,
afterSubmit:null,jqModal:!0,closeOnEscape:!1,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:!1,serializeDelData:null,useDataProxy:!1},a.jgrid.del,b||{});d[a(this)[0].p.id]=b;return this.each(function(){var f=this;if(f.grid&&e){var c=a.isFunction(d[f.p.id].beforeShowForm),h=a.isFunction(d[f.p.id].afterShowForm),g=a.isFunction(d[f.p.id].beforeInitData)?d[f.p.id].beforeInitData:!1,k=f.p.id,l={},m=!0,p="DelTbl_"+a.jgrid.jqID(k),r,q,n,s,t="DelTbl_"+k,v={themodal:"delmod"+
k,modalhead:"delhd"+k,modalcontent:"delcnt"+k,scrollelm:p};a.isArray(e)&&(e=e.join());if(void 0!==a("#"+a.jgrid.jqID(v.themodal))[0]){g&&(m=g.call(f,a("#"+p)),void 0===m&&(m=!0));if(!1===m)return;a("#DelData>td","#"+p).text(e);a("#DelError","#"+p).hide();!0===d[f.p.id].processing&&(d[f.p.id].processing=!1,a("#dData","#"+p).removeClass("ui-state-active"));c&&d[f.p.id].beforeShowForm.call(f,a("#"+p));a.jgrid.viewModal("#"+a.jgrid.jqID(v.themodal),{gbox:"#gbox_"+a.jgrid.jqID(k),jqm:d[f.p.id].jqModal,
