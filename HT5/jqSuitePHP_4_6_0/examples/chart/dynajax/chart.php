...
->addSeries('Tokyo', array(7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9 ))
...
$("#mybutton").click(function(){
	$.ajax({
		url: 'myjsondata.txt',
		dataType : 'json',
		success : function( response, stat, error) {
			// chart object is already created so we refer to it.
			// look at renderChart parameters for more information
	...
	// add a new point to existing Series
	chart.series[0].addPoint( 9.6 );
	
});
AJAX;

$chart->setJSCode( $ajax );
