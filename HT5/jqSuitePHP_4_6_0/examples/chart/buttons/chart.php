...
->setExporting(array("buttons"=>array("exportButton"=>array("menuItems"=>array(
	array("text"=>'PNG download',"onclick"=>"js:function (){this.exportChart();}"), // PNG
	null, //JPEG
	array("text"=>'PDF download',"onclick"=>"js:function (){this.exportChart({type: 'application/pdf'});}"), // PDF
	array("text"=>'SVG download',"onclick"=>"js:function (){this.exportChart({type: 'image/svg+xml'});}") // SVG
