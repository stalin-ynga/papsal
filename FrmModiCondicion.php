...
if($Cod!='A'){
$sql_guardar1="select Codigo,Nombre from tblcondicion WHERE Codigo=".$Cod." ; 
 ";
...
if(isset($_POST["guardar"])>0){
   ...
   if($ban==true){
	  ...
	  header("location:concluye.php?cod=18");
...
<td colspan="2" align="left" bgcolor="#00FF00" style="height: 3px"><form name="f" action="FrmModiCondicion.php" method="post" onSubmit="return validar(this)" class="ww" >
  ...
  <table width="430" border="0">
    <tr>
      <td width="424" height="18" bgcolor="#00CC33"><div align="center" class="Estilo91">Actualizacion De Condicion</div></td>
    </tr>
  </table>
  <table width="430" border="0">
    <tr>
  ...
  <table width="428" border="0">
                            ...
                            <tr>
                              <td width="54"><span class="Estilo9">Condicion</span></td>
                              <td width="364"><label>
