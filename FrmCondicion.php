<?php
include("./clases/ClsCondicion.php");
...
if(isset($_POST["guardar"])>0){
   ...
   if($ban==true){
	    header("location:concluye.php?cod=17");
...
<td colspan="2" align="left" bgcolor="#00FF00" style="height: 3px"><form name="f" action="FrmCondicion.php" method="post" onSubmit="return validar(this)" class="ww" >
  ...
  <table width="430" border="0">
    <tr>
      <td width="424" height="18" bgcolor="#00CC33"><div align="center" class="Estilo91">Registro De Condicion</div></td>
    </tr>
</table>
  <table width="430" border="0">
    <tr>
  ...
  <table width="429" border="0">
                            <tr>
                              <td width="83" class="Estilo9">Condicion</td>
                              <td width="336" class="Estilo9"><input name="nombre" type="text" id="nombre" size="40" maxlength="100"  class="Estilo9" />
                                (*)</td>
                            </tr>
                          </table>
                          <table width="430" border="0">
