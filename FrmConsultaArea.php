...
$sql_guardar1="select Codigo,Nombre,(CASE Estado WHEN 'A' THEN 'ACTIVO' WHEN 'N' THEN 'INACTIVO' ELSE NULL END) AS Estado from tblarea WHERE 1=1".$where." ; 
 ";
...
$sql_guardar1="select Codigo,Nombre,(CASE Estado WHEN 'A' THEN 'ACTIVO' WHEN 'N' THEN 'INACTIVO' ELSE NULL END) AS Estado from tblarea; 
 ";
 $res1 =mysql_query($sql_guardar1,$enlace); 
...
<body>
<center>
<form name="f2" id="f2" method="post" action="FrmConsultaArea.php"  onSubmit="return validar(this);" class="ww">
...
<table width="1044" border="0" class="Estilo9">
  <tr>
    <td width="1034" bgcolor="#33CC00" align="center" class="a">Consultas Y Mantenimiento De Areas</td>
  </tr>
</table>
...
<table width="977" border="0" class="Estilo9">
  <tr>
    <td width="60" height="24"><span class="titulo_cabecera">Area:</span></td>
    ...
    <td width="196"><input type="submit" name="button" id="button" value="FILTRAR" onclick="asigna(this); "  />
      <a href="FrmArea.php"  target="mainFrame" class="ui-widget-header"   onclick="return GB_myShow('D.R.S.A.U', this.href)"><img  src="./images/add.png" alt="" width='15' height='15' border='0' title="Nuevo"/>Nuevo</a></td>
    <td width="47">&nbsp;</td>
    <td width="392">&nbsp;</td>
  </tr>
</table>
	...
	<table width="1043" border="0" cellpadding="0" cellspacing="0" class="sortable Estilo9" id="table">
		...
		?>
			<td><center> <a href="FrmModiArea.php?Cod=<? echo $reg[0]?>"  target="mainFrame" class="ui-widget-header"   onclick="return GB_myShow('D.R.S.A.U', this.href)"><img border='0'  src=./img/btn_edit.gif width='20' height='20' title="Modifica"/></a></td>
			<?
