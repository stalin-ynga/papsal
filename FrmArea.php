...
if(isset($_POST["guardar"])>0){
   ...
   if($ban==true){
	    header("location:concluye.php?cod=15");
...
<td colspan="2" align="left" bgcolor="#00FF00" style="height: 3px"><form name="f" action="FrmArea.php" method="post" onSubmit="return validar(this)" class="ww" >
  ...
  <table width="430" border="0">
    <tr>
      <td width="424" height="18" bgcolor="#00CC33"><div align="center" class="Estilo91">Registro De Areas</div></td>
    </tr>
</table>
  <table width="430" border="0">
    <tr>
  ...
  <table width="429" border="0">
                            <tr>
                              <td width="59" class="Estilo9">Area</td>
                              <td width="360" class="Estilo9"><input name="nombre" type="text" id="nombre" size="40" maxlength="100"  class="Estilo9" />
                                (*)</td>
                            </tr>
                          </table>
                          <table width="430" border="0">
