...
<center>
<form name="importa" method="post" action="CargaReloj2.php" enctype="multipart/form-data" onSubmit="return validar(this)" >
...
echo "<-->Total Registros Subidos: $totalIngresados ";
}
